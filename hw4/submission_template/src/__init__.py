...
if __name__ == '__main__':
    ...
    # cols = range(1,42)
    # print(cols)
    data = pd.read_csv("data/trimed.csv", usecols=[0,1,2,8], parse_dates=[1,2], names = ['unique_key', 'created_date', 'closed_date', 'zipcode' ],dtype={'zipcode': str}, index_col=False)
    print(data.head())
    ...
    data = data.assign(diff_h=(data.closed_date - data.created_date).dt.total_seconds()/3600)
